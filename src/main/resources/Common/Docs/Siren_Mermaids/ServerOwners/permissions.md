...
- mermaids.admin
  - Allows the player to use the command /mermaids admin command line.
- mermaids.admin.mode
...
- mermaids.admin.raintransform
  - Allows the player to use the command /mermaids admin raintransformation [true/false].
- mermaids.admin.mermaidglow
  - Allows the player to use the command /mermaids admin mermaidglow [true/false] and /mermaids admin mermaidglowraduis [int].