...
public class RaceMermaidMoonbinder {
    // Mermaid Moonbinder sorcery tier 2
    public static RaceDefinition createMermaidMoonbinderRace(boolean startUp){
        String id = "mermaid_moonbinder";
        String displayName = "Mermaid Moonbinder";
        String description = "A mythical sea creature who can uses the power of the moon to enchant.";
        if(!startUp) {
            displayName = Message.translation("server.races.mermaidMoonbinder.name").getAnsiMessage();
            description = Message.translation("server.races.mermaidMoonbinder.desc").getAnsiMessage();
        }
        ...
        baseAttributes.put(SkillAttributeType.HASTE, 1.18);
        ...
        baseAttributes.put(SkillAttributeType.FLOW, 29.6);
        baseAttributes.put(SkillAttributeType.SORCERY, 1.26);
        ...
        //Ascension
        String ascensionId = "mermaid_moonbinder";
        ...
        ascensionRequirementsminSkillLevels.put(SkillAttributeType.SORCERY, 250);
