...
public class RaceMermaidQueen {
    // Mermaid Queen hybrid tier 2
    public static RaceDefinition createMermaidQueenRace(boolean startUp){
        String id = "mermaid_queen";
        String displayName = "Mermaid Queen";
        String description = "A mythical sea creature who rules a sea.";
        if(!startUp) {
            displayName = Message.translation("server.races.mermaidQueen.name").getAnsiMessage();
            description = Message.translation("server.races.mermaidQueen.desc").getAnsiMessage();
        }
        ...
        baseAttributes.put(SkillAttributeType.LIFE_FORCE, 107.1);
        baseAttributes.put(SkillAttributeType.STRENGTH, 1.19);
        baseAttributes.put(SkillAttributeType.DEFENSE, 0.96);
        ...
        innateAttributeGainMap.put("value", 1.75);
