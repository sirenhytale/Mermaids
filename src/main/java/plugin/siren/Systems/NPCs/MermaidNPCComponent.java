...
public class MermaidNPCComponent implements Component<EntityStore> {
    ...
    public static ComponentType<EntityStore, MermaidNPCComponent> getComponentType(){
        return Mermaids.get().getMermaidNPCComponentType();
    }

    public MermaidNPCComponent(){
        this(new PlayerSkin());
    }

    public MermaidNPCComponent(PlayerSkin skin){
        this.mermaid = false;
    ...
    public MermaidNPCComponent(MermaidNPCComponent other){
    ...
    public Component<EntityStore> clone() {
        return new MermaidNPCComponent(this);
    }
